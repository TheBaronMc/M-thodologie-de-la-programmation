...
package body p_liste is
   ...
   --exception: aucune
   procedure inserer_en_tete (nouveau: in T_Element; liste: in out liste_chainee) is
   ...
   -- post-condition: aucune
   -- exception: aucune
   function rechercher (e: in T_Element; l: in liste_chainee) return liste_chainee is
      p: liste_chainee := l;
   begin
   ...
   procedure inserer_apres (nouveau: in T_Element; data: in T_Element; liste: in out liste_chainee) is
   ...
   -- post-condition: nouveau appartient à la liste
   -- exception: data n’est pas dans la la liste, la liste est vide
   procedure inserer_avant (data: in T_Element; nouveau: in T_Element; liste: in out liste_chainee) is
      elmt_liste_nouveau : liste_chainee := new noeud;
   ...
   -- exception: aucune
   procedure enlever (e: in T_Element; liste: in out liste_chainee) is
